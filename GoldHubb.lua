...
if not isfile("LongHuyFnfVersion.json") then
	...
	if _Version then
		if _Version.Version ~= VersionHub then
			delfile("LongHuyFnfVersion.json")
			writefile("LongHuyFnfVersion.json",HttpService:JSONEncode({["Version"]=VersionHub}))
		end
...
function MakeData()
	if not isfolder("LongHuyFnfDataVersion".. MyVersion) then
		makefolder("LongHuyFnfDataVersion".. MyVersion)
		writefile("LongHuyFnfDataVersion".. MyVersion .."\\SettingData.json","")
		writefile("LongHuyFnfDataVersion".. MyVersion.."\\HomeData.json","")
		writefile("LongHuyFnfDataVersion".. MyVersion.."\\MicsData.json","")
		DataSetting = readfile("LongHuyFnfDataVersion".. MyVersion.."\\SettingData.json")
		DataHome = readfile("LongHuyFnfDataVersion".. MyVersion.."\\HomeData.json")
		DataMics = readfile("LongHuyFnfDataVersion".. MyVersion.."\\MicsData.json")
	else
		DataSetting = readfile("LongHuyfnfDataVersion".. MyVersion.."\\SettingData.json")
		DataHome = readfile("LongHuyfnfDataVersion".. MyVersion.."\\HomeData.json")
		DataMics = readfile("LongHuyfnfDataVersion".. MyVersion.."\\MicsData.json")
...
function SaveData(DataType,Data)
	...
	elseif DataType == "Home" then
		...
		DataTable = HttpService:JSONEncode(DataTable)
		delfile("LongHuyfnfDataVersion".. MyVersion.."\\HomeData.json")
		DataHome = writefile("LongHuyFnfDataVersion".. MyVersion.."\\HomeData.json", DataTable)
	elseif DataType == "Mics" then
		...
		DataTable = HttpService:JSONEncode(DataTable)
		print(DataTable)
		delfile("LongHuyFnfDataVersion".. MyVersion.."\\MicsData.json")
		DataMics = writefile("LongHuyfnfDataVersion".. MyVersion.."\\MicsData.json", DataTable)
		print(DataMics)
	end
end
